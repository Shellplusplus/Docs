...
2. 退出应用，返回表盘，点击Claude小人<ToolbarPage>![Claude 表盘入口](./images/open-claude-watch-face.png)</ToolbarPage>
3. 点击start<ToolbarPage>![启动 Shell++ 服务](./images/start-shellpp-service.jpg)</ToolbarPage>
4. 此时服务环境就已配置完毕
