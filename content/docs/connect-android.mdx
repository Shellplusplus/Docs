...
1. 打开 Shell++ Android。<ToolbarPage>![Shell++ Android 应用](./images/android-app.png)</ToolbarPage>
2. 在首页确认应用能够发现当前手环。
...
同步过程中可以退出页面探索其他页面<ToolbarPage>![Android 同步页面](./images/android-sync.jpg)</ToolbarPage>
